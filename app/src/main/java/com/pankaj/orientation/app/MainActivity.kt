package com.pankaj.orientation.app
...
class MainActivity : AppCompatActivity() {
    ...
    private var imuInterface: com.launcher.sensordata.aidl.OrientationInterface? = null
    ...
    private fun getDataFromAIDL() {
        imuInterface?.orientationDataProvider()?.let {
    ...
    private fun bindOrientationService() {
        ...
        orientationServiceConnection = object : ServiceConnection {
            override fun onServiceConnected(componentName: ComponentName?, binder: IBinder?) {
                imuInterface = com.launcher.sensordata.aidl.OrientationInterface.Stub.asInterface(binder)
                getDataFromAIDL()
            }
