...
import com.launcher.sensordata.aidl.OrientationInterface
...
class OrientationService : LifecycleService(), SensorEventListener {
    ...
    private val myBinder: OrientationInterface.Stub = object : OrientationInterface.Stub() {
        override fun orientationDataProvider(): String {
            createSensorManager()
            return sensorData.value?.contentToString() ?: "Sensor data is not available"
        }
    }
